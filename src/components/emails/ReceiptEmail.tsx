// reference: https://demo.react.email/preview/receipts/apple-receipt?view=source&lang=jsx
...
const ReceiptEmail = ({
	...
	const fee = 1;
	const totalPrice = products.reduce((acc, cur) => acc + cur.price, 0) + fee;

	return (
		<Html>
			<Head />
			<Preview>Your Digital Giraffe Receipt</Preview>
			...
			<Body style={main}>
				<Container style={container}>
					...
					<Text style={footerCopyright}>
						Copyright © 2024 Digital Giraffe Inc. <br />{" "}
